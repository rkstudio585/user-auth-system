...
3. **Install SQLite3 (if not installed):**
    SQLite3 comes pre-installed with Python, but make sure it's available:
    ```bash
    sqlite3 --version
    ```
...
2. **Available Commands:**
   Once the program is running, you'll see a **help menu** with the following commands:
